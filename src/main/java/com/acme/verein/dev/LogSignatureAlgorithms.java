...
/**
 * Über einen CommandLineRunner werden Informationen für die Entwickler/innen im Hinblick auf Security (-Algorithmen)
...
public interface LogSignatureAlgorithms {
    /**
     * Bean-Definition, um einen CommandLineRunner bereitzustellen, damit die im JDK vorhandenen Signature-Algorithmen
     * aufgelistet werden.
     *
    ...
    default CommandLineRunner logSignatureAlgorithms() {
        final var log = LoggerFactory.getLogger(LogSignatureAlgorithms.class);
        return (final String... args) -> Arrays
